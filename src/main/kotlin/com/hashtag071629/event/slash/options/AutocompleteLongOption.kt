...
public class AutocompleteLongOption internal constructor(name: String, description: String, minValue: Double, maxValue: Double, provider: (ChatInputAutoCompleteEvent) -> List<ApplicationCommandOptionChoiceData>) : AutoCompleteOption<Long>(name, description, provider) {
    init {
